...
their communities and beyond.
        ...
        <section id="what-sets-apart" className="p-8 mb-12 text-center">
          ...
          <div className="mx-auto max-w-2xl">
            <p className="text-lg md:text-2xl max-w-2xl mx-auto mb-6 text-blue-100 font-medium drop-shadow">In today's rapidly evolving world, the ability to adapt, lead, and inspire others is more important than ever. At WANAC,
