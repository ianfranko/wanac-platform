    ...
    <Box sx={{ maxWidth: 800, mx: "auto", p: 4 }}>
      ...
      {rawApiResponse && (
        <Box sx={{ mb: 2, p: 2, bgcolor: '#f5f5f5', borderRadius: 2 }}>
          <Typography variant="subtitle2">Raw API response for getExperiences:</Typography>
          <pre style={{ fontSize: 12, overflowX: 'auto' }}>{JSON.stringify(rawApiResponse, null, 2)}</pre>
        </Box>
      )}
      <Card>
        <CardContent>
