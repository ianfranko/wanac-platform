"use client";
import { addAgendaStep } from "../../../../services/api/experience.service";
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    // Batch save agenda steps
                    const agendaPromises = editExperienceData.agenda
                      .filter(step => step.title.trim())
                      .map(step =>
                        addAgendaStep({
                          experience_id: selectedExperienceToEdit.id,
                          title: step.title,
                    ...
                    setSuccess('Experience and agenda steps updated successfully!');
                    fetchFireteamDetails();
                  } catch (err) {
                    setError('Failed to update experience or agenda steps');
                  }
                }}
