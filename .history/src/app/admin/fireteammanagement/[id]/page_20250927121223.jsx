            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  // Refetch the latest experience from backend to get updated agenda
                  const updatedExperience = await experienceService.getExperience(selectedExperienceToEdit.id);
