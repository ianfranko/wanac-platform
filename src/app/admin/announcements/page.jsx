...
const AdminAnnouncementPage = () => {
  ...
  // Optionally, you can add user state if you want to fetch admin name from localStorage, but for now, use default
      ...
      <div className="flex-1 flex flex-col h-full transition-all duration-300">
        ...
        <main className="flex-1 p-8 ml-0 md:ml-0">
          <div className="max-w-2xl mx-auto p-6 bg-white rounded shadow mt-8">
            <h1 className="text-2xl font-bold mb-4 text-[#002147]">Admin Announcements</h1>
