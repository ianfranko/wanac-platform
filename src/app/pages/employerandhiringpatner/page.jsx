        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              A 12-session, cohort-based program that turns idea → validated model → launch plan using customer discovery, 7-day validation sprints, financial modeling, and a go-to-market roadmap. (Built on the rigor of UCLA Anderson’s venture courses.) </p>
              ...
              <p className="text-sm text-gray-400 mt-4">Cohort-based • National • Scholarships available (one per year)</p>
            </div>
