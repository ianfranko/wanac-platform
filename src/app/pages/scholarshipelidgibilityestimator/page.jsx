          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Find out your eligibility for top PELL, GI Bill®, VR&E, and other scholarships in minutes. Get instant, AI-powered results and personalized next steps.
              </p>
              ...
              <p className="text-sm text-gray-400 mt-4">No cost. No credit card required. 100% secure.</p>
            </div>
