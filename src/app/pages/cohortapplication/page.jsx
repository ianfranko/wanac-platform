...
const CohortApplication = () => {
  return (
    <div className="min-h-screen bg-[#faf9f7]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Early access to the only all-in-one platform for veterans: CRM, AI, PTC, PTC+, and more. Join the next cohort and transform your transition journey.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="border-2 border-[#ff5e1a] text-[#ff5e1a] px-8 py-4 rounded-md text-lg font-semibold hover:bg-[#ff5e1a] hover:text-white transition-colors">
                  Not sure yet? Take the Sandbox app
                </button>
              </div>
              <p className="text-sm text-gray-400 mt-4">Limited seats available • Priority to service members • No obligation to enroll</p>
            </div>
            <div className="relative flex flex-col items-center gap-4">
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6 w-80 mb-4">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 text-base">Cohort Progress</h3>
                    <p className="text-gray-500 text-xs">AI Dashboard</p>
                  </div>
                </div>
              ...
              <div className="absolute top-0 right-0 bg-white rounded-lg shadow-lg p-3 w-48 z-20 border border-[#ff5e1a]">
                ...
                <p className="text-xs text-gray-600">Get instant answers about your cohort!</p>
              </div>
      ...
      {/* Introducing Breeze Agents Section */}
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">WANAC's AI-powered agents help you onboard, retain, and win more veterans with a modern, proactive, and secure customer experience.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Customer Agent */}
            <div className="bg-[#faf9f7] rounded-2xl shadow-lg p-8 flex flex-col items-center">
              <Image src="/customer-agent.png" alt="Customer Agent" width={120} height={80} className="mb-4" />
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Customer Agent</h3>
              <p className="text-gray-600 mb-4 text-center">Onboard, support, and delight veterans with 24/7 AI-powered help.</p>
              <a href="#" className="text-[#ff5e1a] font-semibold hover:text-[#e54e16] transition-colors">Learn more →</a>
            </div>
            {/* Prospecting Agent */}
            <div className="bg-[#faf9f7] rounded-2xl shadow-lg p-8 flex flex-col items-center">
              <Image src="/prospecting-agent.png" alt="Prospecting Agent" width={120} height={80} className="mb-4" />
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Prospecting Agent <span className="text-xs bg-[#ff5e1a] text-white px-2 py-1 rounded ml-2">Beta</span></h3>
              <p className="text-gray-600 mb-4 text-center">Find and engage new members with AI-driven outreach and follow-up.</p>
              <a href="#" className="text-[#ff5e1a] font-semibold hover:text-[#e54e16] transition-colors">Learn more →</a>
            </div>
            {/* Content Agent */}
            <div className="bg-[#faf9f7] rounded-2xl shadow-lg p-8 flex flex-col items-center">
              <Image src="/content-agent.png" alt="Content Agent" width={120} height={80} className="mb-4" />
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Content Agent <span className="text-xs bg-[#ff5e1a] text-white px-2 py-1 rounded ml-2">Beta</span></h3>
              <p className="text-gray-600 mb-4 text-center">Create, schedule, and optimize content for your community automatically.</p>
              <a href="#" className="text-[#ff5e1a] font-semibold hover:text-[#e54e16] transition-colors">Learn more →</a>
            </div>
          </div>
        </div>
      ...
      {/* How HubSpot works & What is WANAC CRM Section */}
      <section className="bg-[#fff7f0] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            {/* Illustration/How HubSpot works */}
            <div className="flex flex-col items-center md:items-start">
              <div className="mb-6">
                <div className="bg-[#ffe3d0] rounded-2xl p-6 flex items-center justify-center">
                  {/* Placeholder for illustration */}
                  <Image src="/how-hubspot-works.png" alt="How HubSpot works" width={180} height={120} />
                </div>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2">How HubSpot works</h3>
              <p className="text-gray-700 text-base">See how our platform brings your team, tools, and data together to drive growth.</p>
            </div>
            {/* What is WANAC CRM? */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">What is WANAC CRM?</h3>
              <p className="text-gray-700 text-lg mb-6">A unified platform for veterans: manage your contacts, automate outreach, track progress, and grow your community—all in one place. WANAC CRM is built for service members, by service members.</p>
              <button className="bg-[#ff5e1a] text-white px-8 py-3 rounded-md text-lg font-semibold hover:bg-[#e54e16] transition-colors mr-4">Get a demo</button>
              <button className="border-2 border-[#ff5e1a] text-[#ff5e1a] px-8 py-3 rounded-md text-lg font-semibold hover:bg-[#ff5e1a] hover:text-white transition-colors">See features</button>
            </div>
          </div>
        </div>
      </section>
