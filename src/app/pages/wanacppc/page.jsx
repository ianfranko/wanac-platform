      ...
      <footer className="bg-[#002147] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              <h4 className="font-bold text-lg mb-4">PPC Resources</h4>
              <ul className="space-y-3 text-gray-300">
                <li><a href="#" className="hover:text-[#ff5e1a] transition-colors">Mission Planner Template</a></li>
                <li><a href="#" className="hover:text-[#ff5e1a] transition-colors">AAR Guide</a></li>
                <li><a href="#" className="hover:text-[#ff5e1a] transition-colors">Performance Scorecard</a></li>
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mt-4">
                Peak performance for every mission
              </p>
            </div>
          </div>
