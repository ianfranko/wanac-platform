...
export default function DonatePage() {
  ...
  return (
    <div className="bg-white text-[#002147]">
      ...
      {/* Hero Section */}
      <section className="min-h-[50vh] bg-[#002147] text-white py-24 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <Image 
            src="/veterans-helping-veterans.jpg" 
            alt="Veterans helping veterans" 
            layout="fill" 
            objectFit="cover"
            priority
          />
        </div>
        <div className="container mx-auto grid grid-cols-12 px-6 relative z-10">
          <div className="col-start-2 col-span-10 md:col-start-3 md:col-span-8 flex flex-col items-center text-center">
            <h1 className="text-5xl font-extrabold leading-tight uppercase tracking-wide mb-6">
              Your Donation Makes a Difference
            </h1>
            <p className="text-xl mt-4 max-w-2xl">
              Help us empower veterans and service members through coaching, community, and support.
            </p>
          </div>
        </div>
      </section>
